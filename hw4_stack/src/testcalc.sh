...
run_test_args_ec "1^2^3^4^5" "Postfix expression: 1 2 3 4 5 ^ ^ ^ ^"$'\n'"Evaluation:         1"
run_test_args_ec "(1x1)^(2x2)^(3+5+6)" "Postfix expression: 1 1 x 2 2 x 3 5 + 6 + ^ ^"$'\n'"Evaluation:         1"
run_test_args_ec "(1-2+1x1)^((2+0x81/9))^(3x65-5+4)^((124 / 2) % (5 - 4))" "Postfix expression: 1 2 - 1 1 x + 2 0 81 x 9 / + 3 65 x 5 - 4 + 124 2 / 5 4 - % ^ ^ ^"$'\n'"Evaluation:         0"
